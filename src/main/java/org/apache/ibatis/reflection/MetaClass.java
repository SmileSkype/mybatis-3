...
public class MetaClass {
   ...
   *  目前有两个方法会涉及到调用该构造方法
   *  ① #forClass(Class<?> type, ReflectorFactory reflectorFactory) 静态方法，创建指定类的 MetaClass 对象
   *  ② #metaClassForProperty(String name) 方法，创建类的指定属性的类的 MetaClass 对象
   * @param type
   ...
   *      reflector.findPropertyName(prop.getName())
   */
