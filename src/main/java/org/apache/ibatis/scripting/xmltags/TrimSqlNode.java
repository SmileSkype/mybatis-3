...
public class TrimSqlNode implements SqlNode {
  ...
  private class FilteredDynamicContext extends DynamicContext {
    ...
    public void applyAll() {
      ...
      // <2> 将 sqlBuffer 大写，生成新的 trimmedUppercaseSql 对象 TrimSqlNode 对 prefixesToOverride 和 suffixesToOverride 属性，都进行了大写的处理，需要保持统一。但是，又不能直接修改 sqlBuffer ，因为这样就相当于修改了原始的 SQL
