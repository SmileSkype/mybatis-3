...
public class SqlSourceBuilder extends BaseBuilder {
  ...
  public SqlSource parse(String originalSql, Class<?> parameterType, Map<String, Object> additionalParameters) {
    ...
    // <3> 执行解析 执行解析。如果匹配到 #{ + } 对后，会调用 ParameterMappingTokenHandler 对应的 #handleToken(String content) 方法
  ...
  /**
   * ParameterMappingTokenHandler ，实现 TokenHandler 接口，继承 BaseBuilder 抽象类，负责将匹配到的 #{ 和 } 对，
  ...
  private static class ParameterMappingTokenHandler extends BaseBuilder implements TokenHandler {
     ...
     * http://static.iocoder.cn/images/MyBatis/2020_02_25/01.png
     */
